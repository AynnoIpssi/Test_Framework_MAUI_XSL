// Fichier : src/BaobaTesterBox.Core/Driver/DriverOptions.cs
namespace BaobaTesterBox.Core.Driver;

public sealed class AppiumDriverManagerOptions
{
    ...
    public bool Chromedriver_autodownload { get; set; } // Pile comme ton JSON
}